...
public class WaterBottleLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mBottleWidth = dip2px(context, DEFAULT_BOTTLE_WIDTH);
        mBottleHeight = dip2px(context, DEFAULT_BOTTLE_HEIGHT);
        mWaterLowestPointToBottleneckDistance = dip2px(context, WATER_LOWEST_POINT_TO_BOTTLENECK_DISTANCE);
