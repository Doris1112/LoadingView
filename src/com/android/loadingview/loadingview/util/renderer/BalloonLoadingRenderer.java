...
public class BalloonLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mGasTubeWidth = dip2px(context, DEFAULT_GAS_TUBE_WIDTH);
        mGasTubeHeight = dip2px(context, DEFAULT_GAS_TUBE_HEIGHT);
        mCannulaWidth = dip2px(context, DEFAULT_CANNULA_WIDTH);
        mCannulaHeight = dip2px(context, DEFAULT_CANNULA_HEIGHT);
        mCannulaOffsetY = dip2px(context, DEFAULT_CANNULA_OFFSET_Y);
        mCannulaMaxOffsetY = dip2px(context, DEFAULT_CANNULA_MAX_OFFSET_Y);
        mPipeBodyWidth = dip2px(context, DEFAULT_PIPE_BODY_WIDTH);
        mPipeBodyHeight = dip2px(context, DEFAULT_PIPE_BODY_HEIGHT);
        mBalloonWidth = dip2px(context, DEFAULT_BALLOON_WIDTH);
        mBalloonHeight = dip2px(context, DEFAULT_BALLOON_HEIGHT);
        mRectCornerRadius = dip2px(context, DEFAULT_RECT_CORNER_RADIUS);
