...
public class Ghost extends View{
	...
	private void drawBody(Canvas canvas) {
		...
		path.quadTo(rectFGhost.right + wspace / 2, rectFGhost.bottom, rectFGhost.right - wspace,
		...
		path.quadTo(rectFGhost.left - 5, rectFGhost.bottom, rectFGhost.left + rectFGhost.width() / 2 - x,
