...
public class FishLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mRiverBankWidth = dip2px(context, DEFAULT_RIVER_BANK_WIDTH);

        mPathFullLineSize = dip2px(context, DEFAULT_PATH_FULL_LINE_SIZE);
        mPathDottedLineSize = dip2px(context, DEFAULT_PATH_DOTTED_LINE_SIZE);
        mFishWidth = dip2px(context, DEFAULT_FISH_WIDTH);
        mFishHeight = dip2px(context, DEFAULT_FISH_HEIGHT);
        mFishEyeSize = dip2px(context, DEFAULT_FISH_EYE_SIZE);
        mRiverWidth = dip2px(context, DEFAULT_RIVER_WIDTH);
        mRiverHeight = dip2px(context, DEFAULT_RIVER_HEIGHT);
