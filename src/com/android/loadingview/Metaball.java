...
public class Metaball extends View{
	...
	public Metaball(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init();
	}
	
	public Metaball(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init();
	}

	public Metaball(Context context, AttributeSet attrs, int defStyleAttr) {
	 ...
	 * @param j
	 * @param i
	 * @param v 控制两个圆连接时候长度，间接控制连接线的粗细，该值为1的时候连接线为直线 <br/>
