...
public class GhostsEyeLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mEyeEdgeWidth = dip2px(context, DEFAULT_EYE_EDGE_WIDTH);

        mEyeInterval = dip2px(context, DEFAULT_EYE_CIRCLE_INTERVAL);
        mEyeBallOffsetY = dip2px(context, DEFAULT_EYE_BALL_OFFSET_Y);
        mEyeCircleRadius = dip2px(context, DEFAULT_EYE_CIRCLE_RADIUS);
        mMaxEyeJumptDistance = dip2px(context, DEFAULT_MAX_EYE_JUMP_DISTANCE);
        mAboveRadianEyeOffsetX = dip2px(context, DEFAULT_ABOVE_RADIAN_EYE_CIRCLE_OFFSET);

        mEyeBallWidth = dip2px(context, DEFAULT_EYE_BALL_WIDTH);
        mEyeBallHeight = dip2px(context, DEFAULT_EYE_BALL_HEIGHT);
